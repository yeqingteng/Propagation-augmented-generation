...
from prompt_tot_fake import SYSTEM_PROMPT, USER_PROMPT_TEMPLATE
...
# 输入输出文件路径
input_file = "/root/autodl-tmp/shiyan/test.jsonl"
output_file = "/root/autodl-tmp/shiyan/test_tot_output.jsonl"
