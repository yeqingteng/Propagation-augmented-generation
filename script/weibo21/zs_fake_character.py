...
from prompt_zs_fake_character import SYSTEM_PROMPT, USER_PROMPT_TEMPLATE
...
# 输入输出文件路径
input_file = "/root/autodl-tmp/shiyan/pubhealth_zero_character.jsonl"
output_file = "/root/autodl-tmp/shiyan/pubhealth_zero_character_output_reason.jsonl"
