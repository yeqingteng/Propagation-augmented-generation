...
from prompt_sc_fake_character import SYSTEM_PROMPT, USER_PROMPT_TEMPLATE
...
# 输入输出文件路径
input_file = "/root/autodl-tmp/shiyan/phemeplus/test111.jsonl"
output_file = "/root/autodl-tmp/shiyan/phemeplus/test111_sc_character_output.jsonl"
