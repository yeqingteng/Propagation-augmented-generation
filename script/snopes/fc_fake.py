...
from prompt_fc_fake import SYSTEM_PROMPT, USER_PROMPT_TEMPLATE
...
# 输入输出文件路径
input_file = "/root/autodl-tmp/shiyan/pubhealth.jsonl"
output_file = "/root/autodl-tmp/shiyan/pubhealth_fc_output.jsonl"
