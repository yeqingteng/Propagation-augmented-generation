...
if __name__ == "__main__":
    # 文件路径
    input_jsonl = "C:/Users/27433/Desktop/politifact_match.jsonl"          # 输入 JSONL 文件
    output_jsonl = "C:/Users/27433/Desktop/politifact_match_10.jsonl"      # 输出 JSONL 文件
    characters_file = "C:/Users/27433/Desktop/characters_new.json"  # characters.json 文件
...
if __name__ == "__main__":
    # 文件路径
    classifier_file = "C:/Users/27433/Desktop/politifact_classifier.jsonl"  # 输入文件（原始数据）
    select_file = "C:/Users/27433/Desktop/politifact_match_10.jsonl"           # 输入文件（selected_characters）
    output_file = "C:/Users/27433/Desktop/politifact_round0.jsonl"  # 输出文件
