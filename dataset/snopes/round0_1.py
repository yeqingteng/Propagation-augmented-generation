...
# 输入文件路径
jsonl_file_path = "/root/autodl-tmp/shiyan/snopes/test_round0.jsonl"
characters_file_path = "/root/autodl-tmp/shiyan/snopes/characters_new.json"
output_txt_path = "/root/autodl-tmp/shiyan/snopes/results_snopes_round01.txt"  # 改为txt输出文件
...
def query_gpt4o(character_info: Dict[str, Any], 
    ...
    # 构建提示词
    prompt = f"""
    Between 2004 and 2015, the rise of the internet and social media enabled rapid spread of claims on topics like politics, health, education, crime, and popular culture.
    In our virtual society, individuals from diverse backgrounds receive, interpret, and share such claims through social networks, reflecting how information flows in the real world.
    NOTE: The timeline years you are in are from 2004 to 2015. Time won't affect your analysis of this information.
    ...
    In our virtual society, partial false information, including but not limited to emotional language, controversy, or sensationalism, 
    often spreads more deeply and reaches a wider audience than truthful information.    
    ...
    According to the result of Step 1(Analyze this <text content> thoroughly from main character's perspective) and your social relationship characters information, consider:
