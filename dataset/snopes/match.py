...
for char_id, char_data in characters_data.items():
    if "interests" in char_data and "snopes" in char_data["interests"]:
        for classifier in char_data["interests"]["snopes"]:
...
input_jsonl_path = "C:/Users/27433/Desktop/test_classifier.jsonl"
