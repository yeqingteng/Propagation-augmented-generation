...
'''
计算ratio和width和depth和新加入的3个指标(新加入的3个指标取平均)
'''
# import json
...
# def main():
#     input_path = "C:/Users/27433/Downloads/results_phemeplus_round01.json"    # 替换为你的输入文件路径
#     output_path = "C:/Users/27433/Downloads/results_phemeplus_round01.jsonl" # 输出文件路径
...
# # 使用示例
# input_filename = 'C:/Users/27433/Downloads/results_phemeplus_round01.jsonl'  # 替换为你的输入文件名
# output_filename = 'C:/Users/27433/Downloads/results_phemeplus_round01111.jsonl'  # 替换为你想要的输出文件名
...
#             "C:/Users/27433/Downloads/results_phemeplus_round01.jsonl", 
