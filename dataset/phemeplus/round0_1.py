...
def query_gpt4o(character_info: Dict[str, Any], 
    ...
    # 构建提示词
    prompt = f"""
    During major public crises, social media is often flooded with unverified and emotional statements. 
    In our virtual society, individuals from diverse backgrounds receive and disseminate this information, simulating how uncertainty and urgency drive information flow in real-world emergency situations.
    NOTE: 
    (1) The timeline years you are in are from 2014 to 2015. 
    ...
    Statements that are true or false but contain important facts or are likely to produce significant positive or negative effects are also relatively easy to spread.
    Statements that are true or false but lack important facts or significant impact are clearly less likely to be spread to others.
    Statements that contain unverified information often arouse people's curiosity and are more likely to be spread to others.
