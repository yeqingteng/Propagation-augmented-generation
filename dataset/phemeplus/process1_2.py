...
# # 使用示例
# input_filename = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12_reason.txt'  # 你的输入文件名
# output_filename = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12.txt'  # 输出文件名
...
# # 使用示例
# input_filename = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12.txt'  # 替换为你的输入文件名
# output_filename = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12.json'  # 替换为你想要的输出文件名
...
# # 使用示例
# input_json = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12.json'  # 替换为你的输入文件路径
# output_json = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12111.json'  # 替换为你想要的输出文件路径
...
# # 使用示例
# jsonl_file_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/test_round1.jsonl'  # JSONL 文件路径
# json_file_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12.json'    # JSON 文件路径
# output_file_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12111.json' # 输出文件路径
...
#     with open('C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12.json', 'r') as f:
#         round_data = json.load(f)
    
#     # Load the character.json file
#     with open('C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/characters_new.json', 'r') as f:
...
#     with open('C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12111.json', 'w') as f:
...
'''
传播完成后, 先去除不合理的情况再对传播情况筛选: round1_2传完后, 主持人要去除对round0的回传现象和对round1的横传现象
'''
#去除对round0的回传现象
# import json
...
#             id_to_match[entry['id']] = entry.get('match', [])
    
#     # 处理每个ID的数据
#     for id_key in data:
#         # 获取对应的match列表
#         match_list = id_to_match.get(id_key, [])
...
#                 # 提取character ID（如"character 101"部分）
#                 target_character = target.split('(')[0].strip()
                
#                 # 如果不在match列表中，则保留
#                 if target_character not in match_list:
#                     new_targets.append(target)
            
#             # 更新传播对象
#             if new_targets:  # 如果还有传播对象
#                 data[id_key][character_key] = new_targets
#             else:  # 如果没有传播对象了，设置为"none"
...
# # 使用示例
# json_file_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12.json'  # 替换为您的JSON文件路径
# jsonl_file_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第一轮传播后/test_round0.jsonl'  # 替换为您的JSONL文件路径
# output_json_file_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12111.json'  # 输出文件路径
...
# # 使用示例
# json_file_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12.json'         # 原始 JSON 数据
# jsonl_file_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/test_round1_num.jsonl'       # 改为字典形式 match 的 JSONL 数据
# output_json_file_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12111.json' # 处理后的输出文件
...
# # ========= 配置 =========
# input_json_filename  = "C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12.json"  # 改成你的路径
# input_jsonl_filename = "C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/test_round1_num.jsonl"  # 改成你的路径
# output_filename      = "C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12111.json" # 改成你的路径
...
# def compute_probability(relation, activity, depth=2):
...
# def process_spread_with_boost_limited(raw_data, receive_counts, depth=2, alpha=0.3):
#     result = {}
...
# # 使用示例
# find_frequent_recommendations_per_id('C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12.json', 
#                                      'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第三轮传播后/many.txt')
...
# # 使用示例
# input_filename = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第三轮传播后/many.txt'  # 你的输入文件名
# output_filename = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第三轮传播后/many.jsonl'  # 输出文件名
...
# 使用示例
input_jsonl = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/test_round1_num.jsonl'  # 替换为你的输入文件路径
output_jsonl = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/test_round1_num111.jsonl'  # 替换为你想要的输出文件路径
...
# 文件路径（根据你的实际路径修改）
jsonl_input_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/test_round1_num111.jsonl'
json_dict_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第二轮传播后/results_phemeplus_round12.json'
jsonl_output_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第三轮传播后/test_round2_num.jsonl'
...
# 输入输出文件路径
original_file = "C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第三轮传播后/test_round2_num.jsonl"       # 原始含 match 列表的文件
count_file = "C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第三轮传播后/many.jsonl"  # 含接收次数的文件
output_file = "C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/phemeplus/v3/第三轮传播后/test_round2_num111.jsonl"        # 输出文件
