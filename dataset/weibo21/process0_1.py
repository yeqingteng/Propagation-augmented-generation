...
# # 使用示例
# input_filename = 'C:/Users/27433/Downloads/results_weibo21_reason.txt'  # 你的输入文件名
# output_filename = 'C:/Users/27433/Downloads/results_weibo21.txt'  # 输出文件名
...
# # 使用示例
# input_filename = 'C:/Users/27433/Downloads/results_weibo21.txt'  # 替换为你的输入文件名
# output_filename = 'C:/Users/27433/Downloads/results_weibo21.json'  # 替换为你想要的输出文件名
...
# # 使用示例
# input_json = 'C:/Users/27433/Downloads/results_weibo21.json'  # 替换为你的输入文件路径
# output_json = 'C:/Users/27433/Downloads/results_weibo21_111.json'  # 替换为你想要的输出文件路径
...
# json_file_path = 'C:/Users/27433/Downloads/results_weibo21.json'    # JSON 文件路径
# output_file_path = 'C:/Users/27433/Downloads/results_weibo21_111.json' # 输出文件路径
...
# 输入和输出文件路径
input_file = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第一轮传播后/results_weibo21_round01.json'
output_file = 'C:/Users/27433/Desktop/results_weibo21_round01.jsonl'
...
def process_entry(entry_id, entry_data):
    ...
    return {
        "id": entry_id,
        "need": 1,
        "ratio_num": round(spread_rate, 2),  # 保留实际比例，小数位数可调整
...
# # 使用示例
# input_filename = 'C:/Users/27433/Downloads/results_weibo21.jsonl'  # 替换为你的输入文件名
# output_filename = 'C:/Users/27433/Downloads/results_weibo21111.jsonl'  # 替换为你想要的输出文件名

# convert_id_to_int(input_filename, output_filename)
# print(f"处理完成，结果已保存到 {output_filename}")

'''
添加need,ratio和width(修改版)
'''
# import json
...
#                 item['ratio_num'] = bbb_item.get('ratio_num', None)
...
# # 使用示例
# aaa_file = 'C:/Users/27433/Desktop/test_tot_output.jsonl'
# bbb_file = 'C:/Users/27433/Desktop/results_weibo21.jsonl'
# output_file = 'C:/Users/27433/Desktop/test_tot_character.jsonl'
...
#     with open('C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第一轮传播后/results_weibo21_round01.json', 'r') as f:
...
#     with open('C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第一轮传播后/results_weibo21_round01_new1.json', 'w') as f:
...
'''
(1)对于传播对象> 3个的情况: 先按传播概率公式进行筛选 (倾向性 + 活跃度 + 衰减)——筛选完后有可能还存在 > 3个的情况

(2)(针对筛选后仍 > 3个传播对象的情况)每人最多保留 3 个传播对象, 按以下剪枝规则执行
...
# # ========= 配置 =========
# input_filename  = "C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第一轮传播后/results_weibo21_round01_new1.json"
# output_filename = "C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第一轮传播后/results_weibo21_round01_new2.json"
...
# def compute_probability(relation, activity, depth=1):
#     """综合三要素计算传播概率"""
...
# # ========= Step 1：概率初筛（仅对原始对象数 > 3 的角色）=========

# def process_spread_selectively(data, depth=1, max_targets=3):
#     """只对传播对象数 > max_targets 的角色进行概率筛选"""
#     result = {}
#     for claim_id, characters in data.items():
#         result[claim_id] = {}
...
#                 prob     = compute_probability(relation, activity, depth)
...
#         remaining = max_targets - len(final_targets)
...
#     # Step 1：选择性概率初筛
#     step1_result = process_spread_selectively(raw_data, depth)
...
# # 使用示例
# find_frequent_recommendations_per_id('C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第一轮传播后/results_weibo21_round01_new2.json', 
#                                      'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第二轮传播后/many.txt')
...
# # 文件路径（根据你的实际路径修改）
# jsonl_input_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第一轮传播后/test_round0.jsonl'
# json_dict_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第一轮传播后/results_weibo21_round01_new2.json'
# jsonl_output_path = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第二轮传播后/test_round1.jsonl'
...
# # 使用示例
# input_filename = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第二轮传播后/many.txt'  # 你的输入文件名
# output_filename = 'C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第二轮传播后/many.jsonl'  # 输出文件名
...
# # 输入输出文件路径
# original_file = "C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第二轮传播后/test_round1.jsonl"       # 原始含 match 列表的文件
# count_file = "C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第二轮传播后/many.jsonl"  # 含接收次数的文件
# output_file = "C:/Users/27433/Desktop/Claim Detection/IAG/shiyan/weibo21/v3/第二轮传播后/test_round1_num.jsonl"        # 输出文件
