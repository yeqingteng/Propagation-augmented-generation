...
with open("C:/Users/27433/Desktop/characters_weibo21.json", "r") as f:
...
for char_id, char_data in characters_data.items():
    if "interests" in char_data and "weibo21" in char_data["interests"]:
        for classifier in char_data["interests"]["weibo21"]:
...
input_jsonl_path = "C:/Users/27433/Desktop/test.jsonl"
output_jsonl_path = "C:/Users/27433/Desktop/test_match.jsonl"
